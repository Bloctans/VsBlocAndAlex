...
class ApplicationMain
{
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "140";
		app.meta["company"] = "bloctabs";
		app.meta["file"] = "Funkin";
		app.meta["name"] = "Friday Night Funkin In Workspace Madness!'";
		app.meta["packageName"] = "com.bloctansplusvarity.funkin";
		app.meta["version"] = "0.3 BLOC ENGINE";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin In Workspace Madness!'",
			width: 1280,
			x: null,
			y: null,
		};
