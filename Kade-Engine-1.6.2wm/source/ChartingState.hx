...
class ChartingState extends MusicBeatState
{
	...
	public var disableanticheat:Bool = false;
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		{
			//classic dav and bamber moment haha funni funni i coded this heck myself
			//also disableantihcheat cuz we need to chart 
			if (disableanticheat == false)
				switch(PlayState.SONG.song.toLowerCase()) {
					case "exasperation":
						PlayState.SONG = Song.conversionChecks(Song.loadFromJson('danger', 'danger'));
